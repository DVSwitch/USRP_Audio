This updated version of `USRPAudio.py` reflects the current implementation for your DVSwitch environment. The documentation below is tailored to this specific code structure to help you manage the service on your server or workstation.

---

### Overview

`USRPAudio.py` is a lightweight Python 3 bridge that enables full-duplex VoIP-to-Radio audio streaming. It uses UDP to communicate with a bridge (such as `EchoLink_Bridge`) and uses `PyAudio` to interface with your system's sound card.
...
The following diagram illustrates how your ThinkStation or NUC sits between the digital network bridge and the local audio hardware.
...
Are there specific parts of this logic you need to modify for your DVSwitch implementation?
